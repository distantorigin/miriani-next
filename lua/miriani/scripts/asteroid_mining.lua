...
<triggers>
  ...
  <trigger
   ...
   send_to="12"
  >
  <send>mplay("activity/asteroid/rampDown", "other", nil, nil, nil, nil, nil, nil, nil, -25)</send>
  </trigger>
  ...
  <trigger
   ...
   send_to="12"
  >
  <send>mplay("activity/asteroid/rampStart", "other", nil, nil, nil, nil, nil, nil, nil, -25)</send>
  </trigger>
