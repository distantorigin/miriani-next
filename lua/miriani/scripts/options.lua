...
local options = {
  ...
  automatic_changelog = {descr="Automatically open changelog after updates.", value="no", group="updates", type="bool"},
  automatic_updates = {descr="Automatically apply updates quietly at login.", value="no", group="updates", type="bool"},
  ...
  social_cat_reaction = {descr="Reaction (approvals, disapprovals, confusion).", value="yes", group="socials", type="bool"},
  ...
  social_cat_dances = {descr="Dances (tango, waltz, macarena, etc).", value="yes", group="socials", type="bool"},
  ...
  trim_trailing_spaces = {descr="Remove trailing spaces from commands before sending.", value="no", group="general", type="bool"},
  ...
  update_idle = {descr="Automatically apply updates while idle.", value="no", group="updates", type="bool"},
  update_sound = {descr="Play a sound for pending updates.", value="yes", group="updates", type="bool"},
  update_restart_action = {descr="For quiet updates that need a client restart: notify you on return, or restart automatically.", value="notify", group="updates", type="enum", options={"notify", "auto"}},
...
local group_metadata = {
  ...
  {key = "room", title = "Room and Environment", order = 5},
  {key = "helpers", title = "Helpers and Extras", order = 6},
  ...
  {key = "socials_reaction", title = "Reaction", order = 14},
  {key = "socials_novelty", title = "Novelty", order = 15},
  {key = "socials_songs", title = "Songs", order = 16},
  {key = "socials_dances", title = "Dances", order = 17},
  {key = "socials_uncategorized", title = "Uncategorized", order = 18},
  {key = "scan_formats", title = "Configure Scan Templates", order = 19},
  {key = "buffers", title = "Output Buffers", order = 20},
