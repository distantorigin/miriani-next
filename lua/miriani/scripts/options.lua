...
local group_metadata = {
  ...
  {key = "gags", title = "Gags and Substitutions", order = 6},
  {key = "socials", title = "Social Sounds", order = 7},
  {key = "socials_laughter", title = "Laughter", order = 8},
  {key = "socials_distress", title = "Distress", order = 9},
  {key = "socials_reflex", title = "Reflex", order = 10},
  {key = "socials_bodily", title = "Bodily", order = 11},
  {key = "socials_physical", title = "Physical", order = 12},
  {key = "socials_reaction", title = "Reaction", order = 13},
  {key = "socials_novelty", title = "Novelty", order = 14},
  {key = "socials_songs", title = "Songs", order = 15},
  {key = "socials_dances", title = "Dances", order = 16},
  {key = "socials_uncategorized", title = "Uncategorized", order = 17},
  ...
  {key = "mutes", title = "Muted Sounds", order = 23},
  {key = "colors", title = "Color Customization", order = 24},
  {key = "screen reader", title = "Screen Reader Integration", order = 25},
  {key = "developer", title = "Developer Options", order = 26},
} -- group_metadata
