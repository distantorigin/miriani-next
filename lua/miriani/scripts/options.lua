...
local options = {
  ...
  social_cat_laughter = {descr="Laughter sounds.", value="yes", group="socials", type="bool"},
  social_cat_distress = {descr="Distress sounds.", value="yes", group="socials", type="bool"},
  social_cat_reflex = {descr="Reflex sounds.", value="yes", group="socials", type="bool"},
  social_cat_bodily = {descr="Bodily sounds.", value="yes", group="socials", type="bool"},
  social_cat_physical = {descr="Physical sounds.", value="yes", group="socials", type="bool"},
  social_cat_novelty = {descr="Novelty sounds.", value="yes", group="socials", type="bool"},
  social_cat_uncategorized = {descr="Uncategorized sounds.", value="yes", group="socials", type="bool"},
