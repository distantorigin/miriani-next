...
local group_metadata = {
  ...
  {key = "socials_novelty", title = "Novelty", order = 13},
  {key = "socials_songs", title = "Songs", order = 14},
  ...
  {key = "themes", title = "Sound Themes", order = 20},
  {key = "mutes", title = "Muted Sounds", order = 21},
  {key = "colors", title = "Color Customization", order = 22},
  {key = "screen reader", title = "Screen Reader Integration", order = 23},
  {key = "developer", title = "Developer Options", order = 24},
} -- group_metadata
