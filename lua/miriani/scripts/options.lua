...
local group_metadata = {
  ...
  {key = "themes", title = "Sound Themes", order = 21},
  {key = "mutes", title = "Muted Sounds", order = 22},
  {key = "colors", title = "Color Customization", order = 23},
  {key = "screen reader", title = "Screen Reader Integration", order = 24},
  {key = "developer", title = "Developer Options", order = 25},
} -- group_metadata
